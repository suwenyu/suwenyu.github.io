        ...
        <div class="row">
            ...
            <div class="col-sm-6 offset-sm-2">
                ...
                <div class="ui tag labels">
                  <a class="ui label" href="https://github.com/suwenyu"><i class="github alternate icon"></i> Github</a>
                  <a class="ui label" href="https://www.linkedin.com/in/suwenyu"><i class="linkedin icon"></i> LinkedIn</a>
                  <a class="ui label" href="mailto:wsu23@uic.edu"><i class="envelope icon"></i> Email</a>
